...
<div class="container-fluid main_content" >
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-lg-2 " style="padding-top: 2%;">
              <h3 class="text-left">Send Messages Here</h3>
    ...
    <br>
    <button type="button" class="btn btn-success " onclick="sendmsg(par, usr, document.getElementById('msgtext').value)">Send</button>
    <button type="button" class="btn btn-primary" onclick="fetchmsg(par, usr)">Reload</button>
</div>
                </div>
